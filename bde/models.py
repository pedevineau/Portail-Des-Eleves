...
class ParrainageVoeux(models.Model):
    ...
    fillot_n1 = models.ForeignKey(UserProfile, related_name="Voeu1")
    fillot_n2 = models.ForeignKey(UserProfile, related_name="Voeu2")
    fillot_n3 = models.ForeignKey(UserProfile, related_name="Voeu3")
    fillot_n4 = models.ForeignKey(UserProfile, related_name="Voeu4")
    fillot_n5 = models.ForeignKey(UserProfile, related_name="Voeu5")
    fillot_n6 = models.ForeignKey(UserProfile, related_name="Voeu6")
